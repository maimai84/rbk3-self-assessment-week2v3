...
/*
 Complexity: this function has o(1)complexity becasue size not change every time only some times
 and dont has time complexity one operation
 */
...
/*
 Complexity:this functioin has log (n)complexity  complexity because every time we search in ahalfArray
 */
...
/*
 Complexity:complexity o(n^2) because we have to loop throgh the array tow times
 */
