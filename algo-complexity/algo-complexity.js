...
/*
 Complexity: this function has o(n)complexity becasue size not change every time only some times
 and dont has time complexity
 */
...
/*
 Complexity:this functioin has log (n)complexity space complexity because recarsion
 */
